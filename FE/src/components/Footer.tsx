...
const Footer = () => {
  return (
    <footer className="w-full bg-black mt-auto">
      <div className="text-sm text-gray-200 flex sm:flex-row justify-center items-center py-3 gap-2 sm:gap-4">
        <a href="https://github.com/GauravSinghdev/Medium-Clone" target="_blank" rel="noopener noreferrer">
          <BsGithub className="w-6 h-6 me-2" />
        </a>
        <p className="text-center sm:text-left hidden">Copyright © 2024</p>
